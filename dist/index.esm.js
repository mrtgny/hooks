import React, { createContext, useReducer, useMemo, useCallback, useContext, useState, useEffect, forwardRef, useRef, useImperativeHandle } from 'react';
import moment from 'moment';
import 'moment/locale/tr';
import { Route, useHistory as useHistory$1, BrowserRouter, Switch } from 'react-router-dom';
...
var useDimensions = function useDimensions(params) {
  ...
  var onresize = useCallback(function (e) {
...
var Authorized = function Authorized(props) {
  ...
  var onAuthorizeChange = useCallback(function (isAuthorized) {
...
var DateDescription = function DateDescription(props) {
  ...
  }, dayDiff === 1 ? "D\xFCn" : dayDiff ? "".concat(monthDiff || dayDiff, " ").concat(monthDiff ? "ay" : "gün", " \xF6nce") : "Bugün"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: '#aaa',
      margin: 0
    }
...
var OverflowImages = function OverflowImages(props) {
  ...
  }, /*#__PURE__*/React.createElement(props.badgeRenderer, {
...
var InfiniteScrollView = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  if (!firstTimeFetched) {
    return shimmer ? /*#__PURE__*/React.createElement(props.shimmer, null) : /*#__PURE__*/React.createElement(props.loadingRenderer, {
      style: _objectSpread2({}, appStyles.center)
    });
  }
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onFilter: onFilter
  }), hasData ? /*#__PURE__*/React.createElement(React.Fragment, null, data.map(function (item, index) {
    return render(item, index, {
      page: page,
      pageSize: pageSize
    });
  }), hasNextPage ? /*#__PURE__*/React.createElement("div", {
    ref: reloaderRef
  }, shimmer ? /*#__PURE__*/React.createElement(props.shimmer, null) : /*#__PURE__*/React.createElement(props.loadingRenderer, {
    style: _objectSpread2(_objectSpread2({}, appStyles.center), {}, {
      marginTop: 16
    })
  })) : null) : empty);
...
var Loading = function Loading(props) {
  ...
  return /*#__PURE__*/React.createElement(props.loadingRenderer, rest);
};
...
var LogoutButton = function LogoutButton(props) {
  ...
  return /*#__PURE__*/React.createElement(props.renderer, {
    icon: /*#__PURE__*/React.createElement(props.icon, {
      style: {
        fontSize: 16
      }
    }),
...
var QueryAutoComplete = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  return /*#__PURE__*/React.createElement(props.selectfieldRenderer, _extends({}, rest, {
    options: options,
    showSearch: true,
    value: value,
    loading: fetching,
    ...
    return /*#__PURE__*/React.createElement(props.optionsRenderer, {
      key: index,
      value: option.value
    }, option.label);
  }));
...
var Rate = function Rate(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      condition: i
    }, /*#__PURE__*/React.createElement(props.filledStarRenderer, {
      style: {
        color: 'orange',
        fontSize: size
      }
      ...
      condition: !i
    }, /*#__PURE__*/React.createElement(props.emptyStarRenderer, {
      style: {
        color: "orange",
        fontSize: size
      }
...
var Shimmer = function Shimmer(props) {
  ...
  }, /*#__PURE__*/React.createElement(props.skeletonRenderer, _extends({
    loading: true
  }, props)));
};
...
var StarCount = function StarCount(props) {
  ...
  }, quantity), /*#__PURE__*/React.createElement(props.filledStarRenderer, {
    style: {
      color: 'orange',
      fontSize: size
    }
...
var Tag = function Tag(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(props.popoverRenderer, {
    content: /*#__PURE__*/React.createElement(SwatchesPicker, {
      onChange: onColorChange
    }),
    title: "Renk"
  }, /*#__PURE__*/React.createElement(props.buttonRenderer, {
    icon: /*#__PURE__*/React.createElement(props.moreIconRenderer, {
      style: {
        fontSize: 11
      }
    }),
    ...
    onClick: onTextClick
  }, description), /*#__PURE__*/React.createElement(Show, {
    condition: onClear
  }, /*#__PURE__*/React.createElement(props.buttonRenderer, {
    icon: /*#__PURE__*/React.createElement(props.closeIconRenderer, {
      style: {
        fontSize: 11
      }
    }),
